...
<div class="zo-grid-item zo-team-wrap col-xs-12 col-sm-6 col-md-6 col-lg-6">
	<div class="zo-grid-wrap">
		<div class="zo-team-image team-image-left  col-xs-12 col-sm-12 col-md-6 col-lg-6">
			<?php echo the_post_thumbnail('full'); ?>
		</div>
		<div class="zo-team-detail team-content-left col-xs-12 col-sm-12 col-md-6 col-lg-6">
