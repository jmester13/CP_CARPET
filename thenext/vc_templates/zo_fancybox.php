                ...
                for($i=1;$i<=$columns;$i++){ ?>
                    ...
                    ?>
                        <div class="<?php echo esc_attr($item_class);?>">
                            <div class="zo-fancybox-image-inner">
                              <?php if($image_url):?>
                              ...
                              <div class="zo-fancybox-inner zo-fancybox-inner-has-background-wrap" data-zo-skewsize="50" data-zo-bordercolor="#efbd07" data-zo-skew="bottom">
                                <div class="zo-fancybox-inner-has-background-wrap-inner">
                                    <?php if($title):?>
                                    ...
                                    <?php if($atts['button_text']!=''):?>
                                        <div class="zo-fancyboxes-readmore">
                                            <?php
                                            $class_btn = ($atts['button_type']=='button')?'btn btn-large btn-large-cus':'';
                                            $text_button_color = '';
