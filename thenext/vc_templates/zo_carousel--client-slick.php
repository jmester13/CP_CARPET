...
wp_enqueue_script('zo-slick-js', get_template_directory_uri() . '/assets/js/zo_slick.js', array('jquery'));
wp_enqueue_style('zo-slick', get_template_directory_uri() . '/assets/css/slick.css');
?>
<div class="zo-carousel-client-home2 <?php echo esc_attr($atts['template']); ?>" id="<?php echo esc_attr($atts['html_id']); ?>"> 
