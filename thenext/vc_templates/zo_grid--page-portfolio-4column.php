...
<div class="zo-grid-wraper zo-portfolio-wrapper zo-page-portfolio-wraper <?php echo esc_attr($atts['template']); ?>"
     id="<?php echo esc_attr($atts['html_id']); ?>">
        ...
        <?php endif; ?>
        <div class="zo-grid zo-grid-portfolio zo-grid-page-portfolio zo-grid-page-portfolio-columns zo-grid-page-portfolio-4columns <?php echo esc_attr($atts['grid_class']); ?>">
            <?php
            $posts = $atts['posts'];
