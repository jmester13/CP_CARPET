...
<div class="zo-grid-wrapper zo-portfolio-wrapper  <?php echo esc_attr($atts['template']); ?>"
    ...
    <div class="no-container">
        ...
        <?php endif; ?>
        <div class="row zo-grid zo-grid-portfolio zo-grid-portfolio-fullwidth<?php echo esc_attr($atts['grid_class']); ?>">
            <?php
            $posts = $atts['posts'];
            ...
            while ($posts->have_posts()) :
                ...
                <div class="<?php echo esc_attr($atts['item_class']);?>" data-groups='[<?php echo implode(',', $groups);?>]'>
                    <?php get_template_part('single-templates/portfolio/content','full-width'); ?>
                </div>
            <?php
            endwhile;
            ?>
