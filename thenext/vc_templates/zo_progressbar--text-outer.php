<div class="zo-progress-wraper zo-progress-text-outer <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
        ...
        <?php
            ...
            <div id = "zo-progress-<?php echo esc_attr($uqid); ?>" class="<?php echo esc_attr($item_class);?>">
                ...
                <div class="zo-progress-main <?php if( $zo_progress_custom_icon ) { echo 'bar-icon'; } ?> <?php if( $icon ) { echo 'bar-icon'; } ?>">
                    <span class= "zo-progress-value" style="background-color:<?php echo esc_attr($color);?>;">
                        <?php if($show_value): ?>
