                        ...
                        <div class="zo-fancy-box-wrapper clearfix" style="background-color: <?php echo esc_attr($zo_fancybox_bg_content_color); ?>">
                            ...
                            <div class="zo-fancy-box-image w50">
                                ...
                                <div class="zo-fancy-box-meta">
                                    <span class="months-old"><?php echo esc_attr($months_old); ?><br /><?php _e('Months Old', 'thenext'); ?></span>
                                    <span class="class-size"><?php echo esc_attr($class_size); ?><br /><?php _e('Class Size', 'thenext'); ?></span>
                                </div>
                            </div>
                            <?php endif;?>
