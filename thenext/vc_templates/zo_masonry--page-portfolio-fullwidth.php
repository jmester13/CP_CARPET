...
?>
<div class="zo-masonry-wrapper zo-portfolio-wrapper zo-masonry-page-portfolio-wrapper zo-portfolio-overlay-has-prettyphoto <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <?php if( isset($atts['filter']) && $atts['filter'] == 1 ) :?>
        <div class="zo-grid-filter zo-masonry-filter bellow-pagetitle">
