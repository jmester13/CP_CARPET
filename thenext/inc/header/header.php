...
?>
<div id="zo-header-wrap" <?php if (!empty($zo_meta->_zo_enable_header_transparent)) {
    echo 'class="header-page-transparent"';
} ?>>
	
	<!-- Header Top -->
	<div id="zo-header-top" class="zo-header-top-transparent">
		<div class="container">
			<div class="row">
				<div class="container">
					<div
						class="zo-header-top-left col-xs-12 col-sm-6 col-md-6 col-lg-6"><?php if ( is_active_sidebar( 'sidebar-2' ) ) dynamic_sidebar('sidebar-2'); ?></div>
					<div
						class="zo-header-top-right col-xs-12 col-sm-6 col-md-6 col-lg-6"><?php if ( is_active_sidebar( 'sidebar-3' ) ) dynamic_sidebar('sidebar-3'); ?></div>
				</div>
			</div>
		</div>
	</div>
