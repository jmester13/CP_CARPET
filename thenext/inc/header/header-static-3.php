...
?>
<div id="zo-header-wrap-static" <?php if ($zo_meta->_zo_enable_header_fixed) {echo 'class="zo-header-wrap-static-fixed"';}?> >

    <!-- Header Top -->
	<div id="zo-header-top" class="zo-header-top-gray">
		<div class="container">
			<div class="row">
				<div class="container">
	...
	<!-- Navigation -->	
    <div id="zo-header" class="zo-main-header zo-header-static-3   
